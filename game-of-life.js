...
function add_cell(new_x, new_y) {
    let my_cell = {
        ...
        draw: function () {
            /* Sera appelée une seule fois par cellule : lorsqu'il faudra la matérialiser dans le DOM*/
        ...
        update_HTML: function () {
            /* Sera appelée à chaque fois qu'il faudra changer l'état visuel de la cellule ! \ Pourrait faire réellement dépendre la présence de la classe "alive" de la valeur de la propriété alive*/
        ...
        toggle_state: function () {
            ...
            my_cell.alive = !my_cell
                .alive; /* inversion de la valeur (booléenne) de la propriété alive*/
